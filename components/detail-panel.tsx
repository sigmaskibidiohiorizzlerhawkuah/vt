...
export default function DetailPanel({ topic }: DetailPanelProps) {
  if (!topic) {
    return (
      <div className="h-full flex items-center justify-center text-muted-foreground px-6 py-12 sm:px-6 sm:py-12 md:px-0 md:py-0">
